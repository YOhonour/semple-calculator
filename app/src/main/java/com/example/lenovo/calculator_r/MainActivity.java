package com.example.lenovo.calculator_r;
            ...
            case R.id.dot_btn:
                ...
                if (!isCounted){
                    ...
                    if (existedText.contains("+") || existedText.contains("-") ||
                        ...
                        if (param2.length() >= 9){
                            Toast.makeText(this,"已超过最大位数(9位)",Toast.LENGTH_SHORT).show();
...
//            Log.d("Anonymous param2",param2);
                if (existedText.substring(existedText.length()-1).equals("+") ||
                    ...
                    if (param2.contains(".")){
                        if (param2.length() >= 10){
                            Toast.makeText(this,"已达到最大位数(9位)",Toast.LENGTH_SHORT).show();
                        } else {
                            existedText += s;
                        }
                    } else {
    ...
    private void getCondition() {
         ...
         * 例如：21-2
         */
        noStartWithOperator = !existedText.startsWith("-") && ( existedText.contains("+") || existedText.contains("-") || existedText.contains("×") || existedText.contains("÷"));
    }
